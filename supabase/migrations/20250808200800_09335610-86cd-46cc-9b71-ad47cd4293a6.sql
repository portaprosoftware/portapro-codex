...
-- Create/update generic updated_at trigger function
...
DROP TRIGGER IF EXISTS trg_sanitation_checklists_updated_at ON public.sanitation_checklists;
...
DROP TRIGGER IF EXISTS trg_sanitation_checklist_items_updated_at ON public.sanitation_checklist_items;
CREATE TRIGGER trg_sanitation_checklist_items_updated_at
BEFORE UPDATE ON public.sanitation_checklist_items
FOR EACH ROW EXECUTE FUNCTION public.update_updated_at_timestamp();

DROP TRIGGER IF EXISTS trg_sanitation_logs_updated_at ON public.sanitation_logs;
CREATE TRIGGER trg_sanitation_logs_updated_at
BEFORE UPDATE ON public.sanitation_logs
FOR EACH ROW EXECUTE FUNCTION public.update_updated_at_timestamp();

DROP TRIGGER IF EXISTS trg_sanitation_schedules_updated_at ON public.sanitation_schedules;
