-- Drop and recreate customer notes functions with proper structure

-- Drop existing function first
DROP FUNCTION IF EXISTS public.get_customer_notes_with_users(uuid);

-- Create the corrected get_customer_notes_with_users function
...
-- Create the ensure_user_registered function for Clerk users
...
-- Create function for adding customer notes
...
-- Create function for updating customer notes
