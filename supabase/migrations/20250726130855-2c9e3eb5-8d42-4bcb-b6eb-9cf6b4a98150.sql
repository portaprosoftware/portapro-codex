...
-- Add page settings to templates table
...
-- Create RLS policies
CREATE POLICY "Public access to template sections" ON public.template_sections FOR ALL USING (true) WITH CHECK (true);
CREATE POLICY "Public access to section types" ON public.section_types FOR ALL USING (true) WITH CHECK (true);
