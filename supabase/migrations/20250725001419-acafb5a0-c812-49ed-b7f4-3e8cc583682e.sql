-- First, let's update the customer_notes table to use clerk_user_id instead of user_id
-- Add a new column for clerk_user_id
ALTER TABLE public.customer_notes ADD COLUMN clerk_user_id TEXT;
...
ALTER TABLE public.customer_notes DROP COLUMN created_by;
ALTER TABLE public.customer_notes RENAME COLUMN clerk_user_id TO created_by;

-- Update the RPC function to work with clerk_user_id
