-- Phase 1: Database Schema Enhancement for Driver Profile System (Fixed)
...
ALTER TABLE public.profiles ADD COLUMN IF NOT EXISTS supervisor_id TEXT REFERENCES public.profiles(id);
