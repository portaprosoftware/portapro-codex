...
interface RecurringServiceRecord {
  ...
  notification_trigger_type?: string;
  labor_hours?: number;
  parts_cost?: number;
  labor_cost?: number;
  created_at: string;
...
interface RecurringServiceModalProps {
  record: RecurringServiceRecord | null;
  isOpen: boolean;
  onClose: () => void;
...
export const RecurringServiceModal: React.FC<RecurringServiceModalProps> = ({
  ...
  const getTriggerTypeLabel = () => {
    switch (record.notification_trigger_type) {
      case 'date_based':
        return 'Date-Based Recurring';
      case 'mileage_based':
        return 'Mileage-Based Recurring';
      default:
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <DialogDescription className="text-gray-600">
                  {getTriggerTypeLabel()} - {getVehicleName()}
                </DialogDescription>
              </div>
            </div>
          ...
          <Card>
            <CardContent className="p-4">
              ...
              <div className="space-y-3">
                ...
                <div className="grid grid-cols-2 gap-4 text-sm">
                  <div>
                    <span className="text-gray-600">Current Service Date:</span>
          ...
          <Card>
            <CardContent className="p-4">
              <div className="flex items-center gap-2 mb-3">
                ...
                <h3 className="font-medium text-gray-900">Recurring Schedule</h3>
              </div>
              <div className="grid grid-cols-2 gap-4 text-sm">
                <div>
                  <span className="text-gray-600">Trigger Type:</span>
                  <p className="font-medium capitalize">
                    {record.notification_trigger_type?.replace('_', ' ') || 'Not specified'}
                  </p>
                </div>
                {record.next_service_date && (
                  <div>
                    ...
                    <p className="font-medium text-purple-600">
                      {format(new Date(record.next_service_date), "PPP")}
                    </p>
                  </div>
                )}
                {record.next_service_mileage && (
                  <div>
                    ...
                    <p className="font-medium text-purple-600 flex items-center gap-1">
                      ...
                      {record.next_service_mileage.toLocaleString()} miles
                    </p>
                  </div>
                )}
              </div>
