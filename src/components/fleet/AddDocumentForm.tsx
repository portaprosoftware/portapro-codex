...
import { CalendarIcon, FileText, Truck } from "lucide-react";
...
export const AddDocumentForm: React.FC<Props> = ({ onSaved, onCancel }) => {
        ...
        <div>
          ...
          <div className="flex flex-col items-center gap-2">
            <Input
              ...
              className="border-0 outline-0 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-gradient-to-r file:from-blue-500 file:to-blue-600 file:text-white hover:file:from-blue-600 hover:file:to-blue-700"
            />
            {formData.file && (
...
// Vehicle Modal Content Component (copied from original AddDocumentModal)
        ...
        {filteredVehicles.length === 0 ? (
          ...
          filteredVehicles.map((vehicle) => (
            <div 
              key={vehicle.id} 
              className={cn(
                "p-4 cursor-pointer hover:shadow-md transition-shadow border rounded",
