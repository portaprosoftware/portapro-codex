...
export const DVIRFormModal: React.FC<DVIRFormModalProps> = ({ 
  open, 
  onOpenChange, 
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      await qc.invalidateQueries({ queryKey: ["vehicle-dvirs"] });
          ...
          <ScrollArea className="flex-1 px-6">
            <div className="space-y-6 py-4">
              ...
              <div className="space-y-4">
                <h2 className="font-semibold text-lg">Inspection Checklist</h2>
              ...
              {majorDefectPresent && (
                <div className="bg-red-50 border border-red-200 p-4 rounded-lg">
                  <h3 className="font-semibold text-red-700 mb-2">Defect Summary</h3>
                  <p className="text-sm text-red-600">
                    {defectsCount} defect{defectsCount !== 1 ? 's' : ''} found. Vehicle may be out of service.
                  </p>
                </div>
              )}
