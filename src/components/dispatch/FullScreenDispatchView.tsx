        ...
        <DragDropContext onDragEnd={handleDragEnd}>
          <div className="flex flex-col h-full">
            ...
            <div className="flex-1 overflow-hidden relative">
              {timelineView ? (
                <div className="h-full relative" style={{ display: 'grid', gridTemplateColumns: '128px 1fr' }}>
                  {/* Sticky Driver Names Column */}
                  <div className="bg-white border-r border-gray-200 z-20 overflow-y-auto" ref={verticalScrollRef}>
                  ...
                  <div className="relative overflow-x-auto overflow-y-hidden" ref={horizontalScrollRef}>
