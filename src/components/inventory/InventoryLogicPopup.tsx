      ...
      <DialogContent className="max-w-2xl">
        ...
        <div className="space-y-4 text-sm">
          <div className="bg-muted/50 p-4 rounded-lg border border-border">
            <h4 className="font-semibold text-foreground mb-2">1. Adding Tracked Units:</h4>
            <p className="text-muted-foreground">
              ...
              <span className="font-semibold text-foreground"> ➡️ Now you have 10 tracked and 40 bulk units.</span>
            </p>
          </div>
          
          <div className="bg-muted/50 p-4 rounded-lg border border-border">
            <h4 className="font-semibold text-foreground mb-2">2. Adding to Bulk Inventory:</h4>
            <p className="text-muted-foreground">
              ...
              <span className="font-semibold text-foreground"> ➡️ You'll then have the option to mark any or all of those new units as tracked if needed.</span>
            </p>
          </div>
          
          <div className="bg-muted/50 p-4 rounded-lg border border-border">
            <h4 className="font-semibold text-foreground mb-2">✅ Multi-Site Simplicity:</h4>
            <p className="text-muted-foreground">
