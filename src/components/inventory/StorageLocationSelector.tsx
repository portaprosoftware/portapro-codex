...
export function StorageLocationSelector({
  ...
  return (
    <Select value={value} onValueChange={onValueChange} disabled={disabled || isLoading}>
      ...
      <SelectContent className="bg-background border border-border shadow-lg z-[99999] min-w-[250px] max-h-[300px] overflow-y-auto">
        {includeAllSites && (
              ...
              <div className="flex items-center gap-2 w-full">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2">
                    ...
                    {display.isDefault && (
                      <span className="text-[10px] px-1.5 py-0.5 bg-gradient-to-r from-blue-500 to-blue-600 text-white font-bold rounded">
                        Default
                      </span>
                    )}
                  </div>
