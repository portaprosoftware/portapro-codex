    ...
    <div className="max-w-none px-6 py-6 min-h-screen bg-gray-50">
      ...
      <div className="bg-white rounded-lg border shadow-sm p-6 mb-6">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-semibold text-gray-900 font-inter">Services Hub</h1>
            <p className="text-base text-gray-600 font-inter mt-1">Track completed work, manage your service offerings, and generate professional service reports</p>
          </div>
      ...
      <Tabs defaultValue="reports" className="space-y-6">
        <TabsList className="bg-white rounded-full p-1 shadow-sm border">
          <TabsTrigger 
            value="reports" 
            className="data-[state=active]:bg-gradient-to-r data-[state=active]:from-blue-700 data-[state=active]:to-blue-800 data-[state=active]:text-white data-[state=active]:font-bold data-[state=active]:border-l-4 data-[state=active]:border-l-blue-400 rounded-full px-6 py-2"
          >
            Service Records
          </TabsTrigger>
          <TabsTrigger 
